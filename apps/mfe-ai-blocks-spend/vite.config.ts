...
// The "spend" block remote: an independently-deployable Module Federation
// provider that exposes each spend block as `{ schema, Component }`. The web
...
export default defineConfig({
  plugins: [
    ...
    federation({
      ...
      exposes: {
        './spendTrend': './src/spend-trend.ts',
        './spendDonut': './src/spend-donut.ts',
        './spendBreakdown': './src/spend-breakdown.ts',
